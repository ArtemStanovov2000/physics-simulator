...
const Explanation = () => {
    ...
    const canvasGravityRef = useRef(null);
    const canvasTidalForcesRef = useRef(null);
    ...
    useEffect(() => {
        const canvasGravity = canvasGravityRef.current;
        ...
        const canvasTidalForces = canvasTidalForcesRef.current;
        const ctxTidalForces = canvasTidalForces?.getContext('2d');
            ...
            <Route index element={<div tabIndex={0} className={classes.page}>
                    <div className={classes.page}>
                        <div className={classes.buttonBox}>
                            <Link to={"/physics/theRocheLimit"}><Button isNav={true} icon={<ArrowBackButton />} label={"Вернуться к симуляции"}/></Link>
                        </div>
                        <div className={classes.innerBox}>
                            ...
                            <div className={classes.textBox}>
                                ...
                                <canvas className={classes.canvas} ref={canvasGravityRef} width={960} height={500}></canvas>
                            </div>
                            <div className={classes.textBox}>
                                ...
                                <canvas className={classes.canvas} ref={canvasTidalForcesRef} width={960} height={500}></canvas>
