...
const Explanation = () => {
    ...
    const canvasGluonField = useRef(null);
    ...
    useEffect(() => {
        const canvasGluonFieldRef = canvasGluonField.current;
        const ctxGluonField = canvasGluonFieldRef?.getContext('2d');
    ...
    return (<Routes>
            <Route index element={<div className={classes.page}>
                    <div className={classes.buttonBox}>
                        <Link to={"/physics/proton"}><Button isNav={true} icon={<ArrowBackButton />} label={"Вернуться к симуляции"}/></Link>
                    </div>
                    <div className={classes.innerBox}>
                        ...
                        <div className={classes.textBox}>
                            ...
                            <canvas className={classes.canvas} ref={canvasGluonField} width={960} height={500}></canvas>
                        </div>
                        <div className={classes.textBox}>
