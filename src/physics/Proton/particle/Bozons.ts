...
export class Z_bozon extends Bozon {
    ...
    constructor(coordinates: {x: number, y: number}, speedY: number, speedX: number) {
        super(coordinates, 13, 7, speedY, speedX)
        this.name = "Z0"
        this.charge = 0
        this.mass = 91200
        this.color = "#303030"
...
export class WPositiwe_bozon extends Bozon {
    ...
    constructor(coordinates: {x: number, y: number}, speedY: number, speedX: number) {
        super(coordinates, 15, 7, speedY, speedX)
        this.name = "W+"
        this.charge = 1
        this.mass = 80400
        this.color = "#403a3a"
...
export class WNegative_bozon extends Bozon {
    ...
    constructor(coordinates: {x: number, y: number}, speedY: number, speedX: number) {
        super(coordinates, 14, 7, speedY, speedX)
        this.name = "W-"
        this.charge = -1
        this.mass = 80400
        this.color = "#49423d"
