...
const Proton = () => {
    ...
    const onMouseMove = (e) => {
        protonPageCoordinates.setCoordinates(e.clientX - e.target.offsetLeft, e.clientY - e.target.offsetTop);
    };
    return (<Routes>
            <Route index element={<div tabIndex={0} className={classes.page}>
                    <canvas ref={canvasRef} onMouseMove={onMouseMove} onMouseUp={() => setMouseDoun(false)} onMouseDown={() => setMouseDoun(true)} width={window.innerWidth} height={window.innerHeight} className={classes.canvas}>
                    </canvas>
...
//# sourceMappingURL=Proton.jsx.map