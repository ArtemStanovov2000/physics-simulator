...
export type AllQuarks = Anti_U_quark | Anti_D_quark | Anti_C_quark | Anti_S_quark | Anti_T_quark | Anti_B_quark | Quark
export type Bozon = Z_bozon | WPositiwe_bozon | WNegative_bozon

export const quarks: Quark[] = []
export const virtualParticle: AllQuarks[] = []
export const mezons: AllQuarks[] = []
