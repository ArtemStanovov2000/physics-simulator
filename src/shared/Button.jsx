...
const Button = ({ label, isNav, onClick, icon }) => {
    ...
    return (<button onMouseLeave={() => setMouseEnterFlag(false)} onMouseEnter={() => setMouseEnterFlag(true)} className={shadow} onClick={onClick}>
